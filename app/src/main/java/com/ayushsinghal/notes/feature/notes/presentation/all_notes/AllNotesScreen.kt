    ...
    Scaffold(
        topBar = {
            TopBar(
                ...
                onSortButtonPressed = { notesViewModel.onEvent(NotesEvent.ToggleOrderSection) },
                onMenuButtonPressed = { onMenuButtonPressed() },
                onQueryChange = {
                    notesViewModel.onEvent(NotesEvent.SearchNote(it))
        ...
        Box(
            ...
            if (notesViewModel.state.value.notes.isEmpty()) {
                EmptyNotesScreen(
